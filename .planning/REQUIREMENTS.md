...
- [x] **NET-01**: Developer can install a managed wildcard resolver so hostnames under the configured suffix resolve to `127.0.0.1`
...
- [x] **NET-03**: Developer can use HTTPS for active routes with locally trusted certificates generated through `mkcert`
